...
export default class HomePage extends Component {
	...
	return (
        ...
        <SideBar></SideBar>
         	...
         	<div className="row">
         		<div className="col-lg-12">
         			<div className="content ">
         				...
         				<h3 className='whitewash aumentamenos'>Aplicação web destinada á gerenciar de servidores de hospitais publicos do distrito federal.</h3>
         			</div>
         		</div>
         	</div>
         </div>
         ...
         <div className="container espaco">
           <div className="row">
             <div className="col-lg-4"><img src ="http://www.guiabocasanta.com.br/wp-content/uploads/2015/03/HospitalUnimep.jpg" align="middle"/>
